...
double Raven_Feature::TotalWeaponStrength(Raven_Bot* pBot)
{
  ...
  return Tweaker + (1-Tweaker)*(NumSlugs + NumCartridges + NumRockets + NumBombs)/(MaxRoundsForShotgun + MaxRoundsForRailgun + MaxRoundsForRocketLauncher + MaxRoundsForGrenade);
}
